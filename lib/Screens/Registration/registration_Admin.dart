...
class _HomeState extends State<Home> {
 ...
 // FirebaseAuth _auth=FirebaseAuth.instance;
  FirebaseAuth firebaseAdmin=FirebaseAuth.instance;

  void saveUserInfoNow()async{

    firebaseAdmin.createUserWithEmailAndPassword(
    ...
    if(firebaseAdmin!=null){
      Map DriverMap={
        "id":firebaseAdmin.currentUser?.uid,
        "name":namecontroal.text.trim(),
        "Email":emailcontroal.text.trim()

      };
      DatabaseReference driverRef= FirebaseDatabase.instance.ref().child("Admin");
      driverRef.child(firebaseAdmin.currentUser!.uid).set(DriverMap);
    }
    else{
